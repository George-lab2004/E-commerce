...
<div className="relative container mx-auto overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <span class="bg-gray-100 text-gray-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300"> {Price}</span>
...
<td className="col-span-5">{Price}</td>
